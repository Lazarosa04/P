...
public class Read extends NumbersBaseListener {
   ...
   @Override public void enterNumber(NumbersParser.NumberContext ctx) {
   }

   @Override public void exitNumber(NumbersParser.NumberContext ctx) {
   }

   @Override public void enterWord(NumbersParser.WordContext ctx) {
   }

   @Override public void exitWord(NumbersParser.WordContext ctx) {
   }
