...
public class CalculatorParser extends Parser {
	...
	public static final int
		RULE_main = 0, RULE_stat = 1, RULE_show = 2, RULE_assignment = 3, RULE_expr = 4;
	private static String[] makeRuleNames() {
		return new String[] {
			"main", "stat", "show", "assignment", "expr"
		};
	}
	...
	public final MainContext main() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 844L) != 0)) {
				{
				{
				setState(10);
				stat();
	...
	private ExprContext expr(int _p) throws RecognitionException {
		...
		try {
			...
			case T__2:
				...
				setState(30);
				((ExprUnaryOpContext)_localctx).e2 = expr(6);
				}
				break;
			case T__5:
				{
